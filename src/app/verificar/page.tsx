        ...
        return (
             <SectionImg imageUrl={bgImage?.imageUrl} imageHint={bgImage?.imageHint}>
                <Card className="p-6 bg-card/80 text-center">
                    ...
                    <Text as="p" mt="2">Para verificar tu perfil, primero necesitas iniciar sesión.</Text>
                    <Button asChild mt="4">
        ...
        return (
             <SectionImg imageUrl={bgImage?.imageUrl} imageHint={bgImage?.imageHint}>
                <Card className="p-6 bg-card/80 text-center">
                    ...
                    <Text as="p" mt="2">Tu perfil ya cuenta con la insignia de verificación.</Text>
                     <Button asChild mt="4">
        ...
        <SectionImg imageUrl={bgImage?.imageUrl} imageHint={bgImage?.imageHint}>
            <Card className="w-full max-w-md p-6 text-center bg-card/80">
                ...
                <Text as="p" mt="2" color="gray">
                    Obtén la insignia de verificación para dar más confianza a otros usuarios. Es un pago único.
                </Text>

                <Flex direction="column" gap="3" mt="6">
                    <VerificationPayPalButton userId={user.uid} />
                </Flex>
            </Card>
        </SectionImg>
    );
