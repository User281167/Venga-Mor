...
export async function POST(req: Request) {
  try {
    ...
    const CLIENT =
      "ASWoUY2hASGLV457PLVjFP-GpQHdyFUQjfs07h7NnzvuAeMRUiz2GOa_347qPhsvKqAJk9U-ukrRXG_6";
    const SECRET =
      process.env.PAYPAL_SECRET ||
      "ENPCkFzau8A0j4TV51UfP5Shb3i3LU247Myr9m5udpNyI-truW4OvOqgsgtI3PDMU0UodPMKOYShdjMU";
