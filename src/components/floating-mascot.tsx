  ...
  return (
    <div className="fixed top-24 left-4 z-[100] w-auto max-w-xs flex items-center gap-3 justify-start">
      ...
      <Popover.Root open={popoverOpen} onOpenChange={setPopoverOpen}>
        <Popover.Trigger>
          <div className="cursor-pointer relative outline-none ring-0">
            <AnimatePresence>
              {isMusicPlaying && (
                <motion.div 
            ...
            <div className={`rounded-full transition-all duration-500 overflow-hidden bg-transparent p-0 border-0 outline-none flex items-center justify-center ${isMusicPlaying ? 'border-2 border-primary shadow-[0_0_15px_rgba(255,0,85,0.5)]' : 'border-0 shadow-none'}`}>
              <Image
