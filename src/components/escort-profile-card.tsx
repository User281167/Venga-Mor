            ...
            <CardContent className="p-4">
                <div className="flex space-x-4">
                    ...
                    <div className="flex-grow">
                        <h3 className="text-xl font-bold text-accent font-headline">{escort.name}</h3>
                        <p className="text-muted-foreground text-sm mt-1 italic">"{escort.phrase}"</p>
                ...
                <div className="flex justify-between mt-4 space-x-2">
                    <Button variant="outline" className="w-full">Visitar Perfil</Button>
